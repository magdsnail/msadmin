    ...
    apps: [
      {
        ...
        instances: 'max', // max表示最大的 应用启动实例个数，仅在 cluster 模式有效 默认为 fork
        instance_var: "INSTANCE_ID",
        // autorestart: true, // 默认为 true, 发生异常的情况下自动重启
        max_memory_restart: '1G',
        error_file: './logs/nestjs-admin-err.log', // 错误日志文件
        out_file: './logs/nestjs-admin-out.log', // 正常日志文件
